...
{
    public class BisectionMethod : ISolver
    {
        private readonly Problem problem;
        (double, double) startingbounds;

        public BisectionMethod(Problem problem, double lowerstart, double upperstart)
        {
            this.problem = problem;
            startingbounds = (lowerstart, upperstart);
        }
